...
all_writer = pd.ExcelWriter(all_name)
basic_df[base_cols].to_excel(all_writer, index = False, sheet_name = 'basic')
aliphatic_df[base_cols].to_excel(all_writer, index = False, sheet_name = 'aliphatic')
other_df[base_cols].to_excel(all_writer, index = False, sheet_name = 'other')
all_writer.save()
...
icd_writer = pd.ExcelWriter(icd_name)
basic_cyto_df[base_cols].to_excel(icd_writer, index = False, sheet_name = 'basic')
aliphatic_cyto_df[base_cols].to_excel(icd_writer, index = False, sheet_name = 'aliphatic')
other_cyto_df[base_cols].to_excel(icd_writer, index = False, sheet_name = 'other')
icd_writer.save()
